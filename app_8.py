...
# Diccionario nombre de Regiones
conj_name = {
    15615: 'Boa Aventura',
    16070: 'Nova Friburgo',
...
def update_map(region, color_var, size_var, map_layout_data):
    ...
    if region:
        ...
        #color_norm = trd_selection[color_var].clip(0, trd_selection[color_var].quantile(0.9))
        ...
        side_graph = dcc.Graph(figure = go.Figure(
            data=[
    ...
    if selectedData:
        ...
        FIC_dist_data = [go.Histogram(x=trd.FIC,
                         ...
                         go.Histogram(x=trd.iloc[sel_index].FIC,
                                      nbinsx=30, histnorm='probability density', name='Seleccion', opacity=0.75)]
        ...
        ENE_dist_data = [go.Histogram(x=trd.ENE_12,
                                      nbinsx=30, histnorm='probability density', name='Total', opacity=0.75),
                         go.Histogram(x=trd.iloc[sel_index].ENE_12,
                                      nbinsx=30, histnorm='probability density', name='Seleccion', opacity=0.75)]
